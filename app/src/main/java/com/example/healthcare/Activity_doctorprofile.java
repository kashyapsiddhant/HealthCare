...
public class Activity_doctorprofile extends AppCompatActivity {
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        DatabaseReference referenceprofile = FirebaseDatabase.getInstance().getReference("Doctor Register Data");
        referenceprofile.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readuserdata != null){
                    ...
                    Toast.makeText(Activity_doctorprofile.this, "Successfully logged in with user details!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Activity_doctorprofile.this, "Something went wrong! User's details are not synced to firebase!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressDialog.dismiss();
                Toast.makeText(Activity_doctorprofile.this, "Something went wrong!", Toast.LENGTH_SHORT).show();
            }
        });
